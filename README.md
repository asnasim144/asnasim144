...
![LinkedIn](https://img.shields.io/badge/LinkedIn-asnasim144-0A66C2?style=flat-square&logo=linkedin&logoColor=white)
![Email](https://img.shields.io/badge/Email-asnasim144@gmail.com-EA4335?style=flat-square&logo=gmail&logoColor=white)
![GitHub](https://img.shields.io/badge/GitHub-asnasim144-181717?style=flat-square&logo=github&logoColor=white)
</div>
---
`$ whoami`
```ts
const nasim = {
  role      : "Backend Developer @ Valt (Yo Tech)",
  focus     : ["Microservices", "RESTful APIs", "Scalable Systems"],
  languages : ["TypeScript", "JavaScript", "PHP"],
  currently : "Building high-performance backend systems for Orders, Inventory & Finance",
  motto     : "Write code that scales, ship solutions that matter.",
};
```
---
🛠 Tech Stack
...
![CI/CD](https://img.shields.io/badge/CI%2FCD-Pipeline-4A90D9?style=flat-square&logo=githubactions&logoColor=white)
---
💼 Experience
```
